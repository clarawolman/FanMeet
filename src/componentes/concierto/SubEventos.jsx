...
function SubEventos({ subEvento }) {
        ...
        <div className="SubEventoUsuarios">
          ...
          <div className="SubEventoAvatares">
            ...
            {subEvento.usuarios.slice(0, 3).map((usuario) => (
                <img key={usuario.id_usuario} className="SubEventoAvatar" src={usuario.foto_perfil}alt={usuario.nombre}/>
              ))}
  ...
  <span className="SubEventoExtra">
    +{subEvento.usuarios.length - 3}
        ...
        <button className="SubEventoBoton">
          VER MÁS
        </button>
